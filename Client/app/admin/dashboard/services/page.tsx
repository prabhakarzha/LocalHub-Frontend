...
import { getServices, addService } from "@/src/redux/slices/servicesSlice"; // Redux actions
...
export default function ServicesPage() {
  ...
  useEffect(() => {
    dispatch(getServices()); // Fetch services from backend
  }, [dispatch]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await dispatch(addService(data) as any); // Redux action to add service
